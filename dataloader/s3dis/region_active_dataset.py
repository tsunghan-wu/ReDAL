...
class RegionActiveStanford3DDataset:
    def __init__(self, args):
        # Active Learning intitial selection
        self.args = args
        self.selection_iter = 0
        self.label_dataset = RegionStanford3DDataset(args.data_dir, imageset='active-label', voxel_size=0.05)
        self.pool_dataset = RegionStanford3DDataset(args.data_dir, imageset='active-ulabel', voxel_size=0.05)
