...
class ActiveSemKITTI:
    def __init__(self, args):
        # Active Learning intitial selection
        self.args = args
        self.selection_iter = 0
        self.label_dataset = SemKITTI(args.data_dir, imageset='active-label', voxel_size=0.05)
        self.pool_dataset = SemKITTI(args.data_dir, imageset='active-ulabel', voxel_size=0.05)
    ...
    def dump_datalist(self):
        datalist_path = os.path.join(self.args.model_save_dir, f'selection_{self.selection_iter:02d}.json')
